...
public class Interact2bRule extends AdaptationRule {
	...
	protected static SmartLogger logger = SmartLogger.getLogger(Interact2bRule.class);
	...
	public IRuleSystemConfiguration onExecute(IKnowledgeProperty property)throws RuleException {
		...
		logger.info("Ejecutando Regla INTERACT-2b: desactivando SteeringWheel HapticVibration");
